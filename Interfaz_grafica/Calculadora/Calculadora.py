...
num7=PhotoImage(file = 'img/7.png')
num8=PhotoImage(file = 'img/8.png')
num9=PhotoImage(file = 'img/9.png')
num4=PhotoImage(file = 'img/4.png')
num5=PhotoImage(file = 'img/5.png')
num6=PhotoImage(file = 'img/6.png')
el1=PhotoImage(file = 'img/el1.png')
num2=PhotoImage(file = 'img/2.png')
num3=PhotoImage(file = 'img/3.png')
num0=PhotoImage(file = 'img/0.png')
rest=PhotoImage(file = 'img/restar.png')
mult=PhotoImage(file = 'img/multiplicar.png')
summ=PhotoImage(file = 'img/sumar.png')
igual=PhotoImage(file = 'img/igual.png')
divv=PhotoImage(file = 'img/dividir.png')
coma=PhotoImage(file = 'img/coma.png')
